...
const toughBigSpiderGames = [
  ...
  },
  {
    ...
    known: [
      '01 02 03 04 05 06 07 08 09 10 11 12 13 ',
      '--------------------------------------',
      'qh 9h 9c ## 5d qd ## ## kc ## 5c 6d js',
      '9c 7d qd ## 4h 8d 8c ## 9s ## 3c 6c ac',
      '5d 3c 9h ## 2s 6d 8c 6h jd ## 4s qh 8c',
      '5h 2c 4s ## 9s 2d 2d 3s 2s ## 7c 2h jh',
      'kh 8s 7c ## td kd th 6h 3h ## ts 3d tc',
      '--------------------------------------',
